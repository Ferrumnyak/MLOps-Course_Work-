...
от подготовки данных и обучения нескольких моделей до логирования экспериментов, контейнеризации и развёртывания инференс-сервиса в виде REST API.
...
- **Сравнение трёх архитектур**: классический ML, CNN и BERT
...
### 3. **CNN для текста (TensorFlow / Keras)**
Свёрточная нейронная сеть для обработки последовательностей токенов, реализующая альтернативный нейросетевой подход к задаче.

**Особенности:**
- Embedding слой + 1D свертки
- Global Max Pooling
- Плотные слои для регрессии
